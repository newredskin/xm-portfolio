        ...
        <div className="px-3 md:px-10 lg:w-screen lg:px-6 lg:py-4 w-screen">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center justify-end mr-3">
              ...
              {/* Side menu bar */}
              <div className="fixed inset-0 w-[calc(100%-4.5rem)] translate-x-[-100%] bg-teal-950/50 transition duration-300 peer-checked:translate-x-0 md:static md:w-auto md:translate-x-0">
