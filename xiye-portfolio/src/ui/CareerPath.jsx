function CareerPath() {
  return (
    <ul className="grid lg:grid-cols-8 gap-y-4 md:gap-y-6">
      <li className="md:col-span-1 lg:col-start-5 lg:col-span-4 container rounded-xl py-1 px-3 text-stone-200 bg-teal-950/80 top-1/3 left-1/4 shadow-xl">
      ...
      <li className="md:col-span-1 lg:col-start-6 lg:col-span-3 container rounded-xl py-1 px-3 text-stone-200 bg-teal-950/80 top-1/3 left-1/4 shadow-xl">
        <div className="flex justify-between items-center">
      ...
      <li className="md:col-span-1 lg:col-start-3 lg:col-span-2 container rounded-xl py-1 px-3 text-stone-200 bg-teal-950/80 top-1/3 left-1/4 shadow-xl">
        <div className="flex justify-between items-center">
      ...
      <li className="md:col-span-1 lg:col-start-2 lg:col-span-1 container rounded-xl py-1 px-3 text-stone-200 bg-teal-950/80 top-1/3 left-1/4 shadow-xl">
        <div className="flex justify-between items-center">
